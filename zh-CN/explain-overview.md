...
aliases:
  - '/docs/dev/query-execution-plan/'
  - '/docs/dev/reference/performance/understanding-the-query-execution-plan/'
  - '/docs/dev/index-merge/'
  - '/docs/dev/reference/performance/index-merge/'
  - '/tidb/dev/index-merge'
  - '/tidb/dev/query-execution-plan'
---
