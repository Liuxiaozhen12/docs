...
aliases:
  - '/docs/dev/export-or-backup-using-dumpling/'
  - '/tidb/dev/export-or-backup-using-dumpling'
  - '/docs/dev/backup-and-restore-using-mydumper-lightning/'
  - '/docs/dev/how-to/maintain/backup-and-restore/mydumper-lightning/'
  - '/docs/dev/how-to/maintain/backup-and-restore/'
  - '/tidb/dev/backup-and-restore-using-mydumper-lightning/'
---
