...
aliases:
  - '/docs/dev/quick-start-with-tidb/'
  - '/docs/dev/test-deployment-using-docker/'
---
...
5. Access the Prometheus dashboard of TiDB at <http:>.

6. Access the [TiDB Dashboard](/dashboard/dashboard-intro.md) at <http:>. The default username is `root`, with an empty password.
...
8. Access the cluster:
    ...
    - Access the Grafana monitoring dashboard at <http:>. The default username and password are both `admin`.

    - Access the [TiDB Dashboard](/dashboard/dashboard-intro.md) at <http:>. The default username is `root`, and the password is empty.
