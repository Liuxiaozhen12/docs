...
aliases:
  - '/docs/dev/production-deployment-using-tiup/'
  - '/docs/dev/how-to/deploy/orchestrated/tiup/'
  - '/docs/dev/tiflash/deploy-tiflash/'
  - '/docs/dev/reference/tiflash/deploy/'
  - '/tidb/dev/deploy-tidb-from-dbdeployer/'
  - '/docs/dev/deploy-tidb-from-dbdeployer/'
  - '/docs/dev/how-to/get-started/deploy-tidb-from-dbdeployer/'
  - '/tidb/dev/deploy-tidb-from-homebrew/'
  - '/docs/dev/deploy-tidb-from-homebrew/'
